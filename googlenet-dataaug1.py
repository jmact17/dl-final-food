...
def train(model, train_data, train_labels):
    ...
    noise = torch.FloatTensor(inputs.size()[2], inputs.size()[3]).uniform_(-1, 1)
    inputs = inputs * noise
    # random transforms
